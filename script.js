...
function openProjectModal(projectId) {
  ...
  if (projectId === "project1") {
    ...
    content = `
      ...
      <br>
      <p>An AI-powered phishing email detector that integrates the Claude API to analyze email content and identify potential phishing threats in real time.</p>
      <p class="modal-tech"><strong>Tech:</strong> Python, AI, Claude API, FastAPI</p>
      <p class="modal-links"><a href="${ghProfile}" target="_blank" rel="noopener noreferrer">View on GitHub</a></p>`;
    ...
    content = `
      ...
      <br>
      <p>Developing a Vision Transformer-based approach for above-ground forest biomass estimation using Sentinel-1 SAR and Sentinel-2 satellite imagery. Currently conducting a literature review and methodology development toward experimental evaluation and future publication.</p>
      <p class="modal-tech"><strong>Tech:</strong> PyTorch, Vision Transformers, Remote Sensing</p>`;
  } else if (projectId === "project7") {
    content = `
      <h3>Resource-Adaptive Federated Learning</h3>
      <br>
      <p>Final-year capstone research building a federated learning framework that trains a shared model without transferring raw client data, while supporting different model sizes across resource-constrained devices.</p>
      <p class="modal-tech"><strong>Tech:</strong> Python, Federated Learning, Deep Learning</p>
      <p class="modal-links"><a href="${ghProfile}" target="_blank" rel="noopener noreferrer">View on GitHub</a></p>`;
